...
' Description			: Used to create key strokes while running from script
' How to Use			:
...
public class Keyboard {
    ...
    public void type(char character) {
		...
		case '~':
			...
			break;
	/*	case '!':
			doType(VK_EXCLAMATION_MARK);   // NG commented this code, to use '!' for VK_ALT keypress
			break;
	*/	case '@':
			doType(VK_AT);
			break;
...
//			break;
//		case '�':
//			doType(VK_WINDOWS, VK_D);
//			break; 
		case '!':
			doType(VK_SHIFT, VK_ALT, VK_T);
			break; 
        default:
